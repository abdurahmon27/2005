...
export function HeroSection() {
  ...
  return (
    <section className="container mx-auto h-full flex flex-col items-center justify-center gap-8 pb-12 md:flex-row md:gap-12 md:pb-24">
      <div className="relative aspect-square h-48 w-48 overflow-hidden rounded-full border-2 md:h-64 md:w-64">
        <Image
          src="/avatar.jpg"
          alt="bekzotovich.uz"
          fill
      ...
      <div className="flex flex-col items-center text-center md:items-start md:text-left">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <Link
            href="https://www.youtube.com/channel/UC6j51JFDtA1AsUyPMbG81Xg"
            target="_blank"
          ...
          >
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 bg-white/5 hover:bg-red-600/10 rounded-xl transition-all duration-300 hover:scale-110"
            >
              <svg
            ...
            {!loading && subscribers !== null && (
              <div className="absolute left-[2.6rem] top-1/2 -translate-y-1/2 min-w-[52px] h-5 flex items-center">
                <div className="bg-white/10 backdrop-blur-sm border border-red-500/30 rounded-full px-2 py-0.5 text-[10px] font-medium text-foreground whitespace-nowrap flex items-center gap-1">
          ...
          >
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 bg-white/5 hover:bg-blue-600/10 rounded-xl transition-all duration-300 hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
          ...
          <Link
            href="https://www.linkedin.com/in/abdurahmon-mamadiyorov/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Button
          ...
          >
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 bg-white/5 hover:bg-cyan-500/10 rounded-xl transition-all duration-300 hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
