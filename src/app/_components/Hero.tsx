        ...
        <section className="container mx-auto h-full flex flex-col items-center justify-center gap-8 pb-12 md:flex-row md:gap-12 md:pb-24">
            ...
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
                ...
                <div className="mt-4 flex gap-4">
                    ...
                    <Link href="https://github.com/abdurahmon27" target="_blank" rel="noopener noreferrer">
                        <Button variant="ghost" size="icon" className="h-9 w-9">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    ...
                    <Link href="https://www.linkedin.com/in/abdurahmon-mamadiyorov/" target="_blank" rel="noopener noreferrer">
                        <Button variant="ghost" size="icon" className="h-9 w-9">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    ...
                    <Link href="https://t.me/abdurahmon_mamadiyorov" target="_blank" rel="noopener noreferrer">
                        <Button variant="ghost" size="icon" className="h-9 w-9">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
