...
// Hand-drawn line pattern components with engineering sketch aesthetic
export const SketchyHorizontalLine = ({
  ...
  <svg width={width} height={height} viewBox="0 0 200 4" className={className} preserveAspectRatio="none">
    <path
...
export const SketchyVerticalLine = ({
  ...
  <svg width={width} height={height} viewBox="0 0 4 200" className={className} preserveAspectRatio="none">
    <path
...
export const SketchyCornerBracket = ({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" className={className}>
      <path d={getPath()} stroke="currentColor" strokeWidth="0.8" fill="none" strokeLinecap="round" opacity="0.7" />
    </svg>
  )
}
...
export const SketchyDashedLine = ({
  ...
  if (direction === "vertical") {
    return (
      <svg width={width} height={height} viewBox="0 0 4 200" className={className} preserveAspectRatio="none">
        <g stroke="currentColor" strokeWidth="0.8" fill="none" strokeLinecap="round" opacity="0.7">
...
export const SketchyWavyLine = ({
  ...
  <svg width={width} height={height} viewBox="0 0 200 8" className={className} preserveAspectRatio="none">
    <path
...
// Utility component for creating sketchy borders around elements
