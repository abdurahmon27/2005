  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 ${
        scrolled ? "bg-secondary backdrop-blur-sm shadow-md" : "bg-transparent"
      }`}
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        >
          <span
            className={`block h-0.5 w-6 bg-current rounded-sm transition-all duration-300 ease-in-out ${
              mobileMenuOpen ? "rotate-45 translate-y-1.5" : ""
            }`}
          ></span>
          <span
            className={`block h-0.5 w-6 bg-current rounded-sm transition-all duration-300 ease-in-out mt-1.5 ${
      ...
      <div
        id="mobile-menu"
        className={`md:hidden fixed right-0 w-3/4 h-screen bg-secondary z-40 transition-transform duration-300 ease-in-out ${
